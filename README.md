...
👨‍💻 I usually code with JavaScript. My typical web-stack looks like this: [NextJS w/ TypeScript (Frontend)](https://nextjs.org), [TailwindCSS](https://tailwindcss.com), WAGMI (for dApps), Mongo (Database)
